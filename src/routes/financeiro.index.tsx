...
import { CheckCircle2, FileText, Loader2, MessageCircle, MoreVertical, Plus, Pencil, Printer, Search, Trash2, X } from "lucide-react";
...
function Financeiro() {
  ...
  return (
    <>
      <PageHeader
        title="Mensalidades"
        description="Gerenciamento de mensalidades dos alunos"
        actions={
