          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl border border-gray-100 p-6 sm:p-8">
                <h2 className="text-lg font-semibold text-[#0B2B4F] mb-6">Envie sua mensagem</h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        ...
                        <input type="text" className="w-full h-11 px-4 rounded-lg border border-gray-200 text-sm outline-none focus:border-[#0B2B4F] transition-colors" required />
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-sm font-medium text-gray-700">E-mail</label>
                        <input type="email" className="w-full h-11 px-4 rounded-lg border border-gray-200 text-sm outline-none focus:border-[#0B2B4F] transition-colors" required />
                      </div>
                    </div>
                    <div className="space-y-1.5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea rows={5} className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm outline-none focus:border-[#0B2B4F] transition-colors resize-none" required />
                    </div>
                    <button type="submit" className="inline-flex items-center gap-2 h-11 px-6 rounded-lg bg-[#0B2B4F] text-white font-medium text-sm hover:bg-[#0B2B4F]/90 transition-colors">
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-xl border border-gray-100 p-5">
                <MapPin className="size-5 text-[#0B2B4F] mb-2" />
              ...
              <div className="bg-gray-50 rounded-xl border border-gray-100 p-5">
                <Clock className="size-5 text-[#0B2B4F] mb-2" />
