...
const navLinks = [
  ...
  { label: "Institucional", to: "/site/institucional" },
  { label: "Transparência", to: "/site/transparencia" },
  { label: "Notícias", to: "/site/noticias" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <nav className="hidden lg:flex items-center gap-1">
              {navLinks.map((link) => {
                const isActive = link.to === "/site" ? pathname === "/site" : pathname.startsWith(link.to);
                return (
                  <Link
                    key={link.to}
                    to={link.to}
