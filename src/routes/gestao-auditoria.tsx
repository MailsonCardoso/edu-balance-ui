...
function StatusIcon({ status }: { status: string }) {
  ...
  if (status === "rejected" || status === "cancelled" || status === "expired")
    return <Ban className="size-3.5 text-red-500" />;
                ...
                <tbody>
                  {data.data.map((item: AuditoriaItem) => {
                    ...
                    return (
                      ...
                      >
                        <td
                          className="py-3 px-3 font-medium text-foreground max-w-[200px] truncate"
                        ...
                        <td
                          className="py-3 px-3 font-mono text-xs text-muted-foreground max-w-[200px] truncate"
                          title={item.e2e_id || ""}
                        >
                          {item.e2e_id || "-"}
                        </td>
