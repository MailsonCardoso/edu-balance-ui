...
export const alunos: Aluno[] = [
  ...
  },
  {
    ...
    cpf: "222.333.444-55",
    dataNascimento: "2013-07-22",
    telefone: "(11) 98888-2222",
    email: "bruno@email.com",
    endereco: "Rua B, 200",
    responsavel: "Patrícia Lima",
    cpfResponsavel: "888.777.666-55",
  ...
  },
  {
    ...
    cpfResponsavel: "777.666.555-44",
    telefoneResponsavel: "(11) 99999-3333",
    turma: "9º Ano A",
    status: "ativo",
    situacao: "pendente",
  },
  {
    ...
    nome: "Diego Almeida",
    cpf: "444.555.666-77",
    dataNascimento: "2016-01-18",
    telefone: "(11) 98888-4444",
    email: "diego@email.com",
    endereco: "Rua D, 400",
    responsavel: "Marcela Almeida",
    cpfResponsavel: "666.555.444-33",
  ...
  },
  {
    ...
    telefoneResponsavel: "(11) 99999-5555",
    turma: "5º Ano B",
    status: "ativo",
    situacao: "inadimplente",
  },
  ...
  },
  {
    ...
    cpf: "777.888.999-00",
    dataNascimento: "2017-02-25",
    telefone: "(11) 98888-7777",
    email: "gio@email.com",
    endereco: "Rua G, 700",
    responsavel: "Lucas Pereira",
    cpfResponsavel: "333.222.111-00",
    telefoneResponsavel: "(11) 99999-7777",
    turma: "1º Ano A",
    status: "ativo",
    situacao: "pendente",
  },
  {
    ...
    cpf: "888.999.000-11",
    dataNascimento: "2011-12-08",
    telefone: "(11) 98888-8888",
    email: "henrique@email.com",
    endereco: "Rua H, 800",
    responsavel: "Vanessa Martins",
    cpfResponsavel: "222.111.000-99",
...
export const mensalidades: Mensalidade[] = [
  ...
  },
  {
    id: "m7",
    alunoId: "5",
    alunoNome: "Eduarda Castro",
    competencia: "09/2025",
    vencimento: dateOffset(-3, 10),
    valor: 950,
    status: "vencido",
  },
  {
  ...
  },
  {
    id: "m10",
    alunoId: "6",
    alunoNome: "Fernando Oliveira",
    competencia: "12/2025",
    vencimento: dateOffset(0, 15),
    valor: 1050,
    valorPago: 1050,
    status: "pago",
  },
